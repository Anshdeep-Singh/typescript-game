...
export class Player extends Sprite {
    ...
    constructor({ collisionBlocks = [], imageSrc, frameRate, animations, loop,height,width }: { collisionBlocks?: any[];  imageSrc: string; frameRate: number; animations: any; loop?: boolean; height: number; width: number;        
    }) {
      super({ imageSrc,frameRate, animations, loop,height,width } as any)
